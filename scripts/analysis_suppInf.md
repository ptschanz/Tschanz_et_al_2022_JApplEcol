...
-   [1 Preliminaries](#1-preliminaries)
    -   [1.1 Load data sets](#11-load-data-sets)
-   [2 Supplementary analysis](#2-supplementary-analysis)
    -   [2.1 Species diversity](#21-species-diversity)
    -   [2.2 Effect of bare ground cover on nesting incidence and
        potential confounding with distance from field
        edge](#22-effect-of-bare-ground-cover-on-nesting-incidence-and-potential-confounding-with-distance-from-field-edge)
        -   [2.2.1 Effects of distance form field edge on proportion of
            bare
            ground](#221-effects-of-distance-form-field-edge-on-proportion-of-bare-ground)
        -   [2.2.2 Effects of proportion of bare ground on nesting
            excluding data from the two transects closest to field
            edges](#222-effects-of-proportion-of-bare-ground-on-nesting-excluding-data-from-the-two-transects-closest-to-field-edges)
-   [3 Supplementary figures](#3-supplementary-figures)
    -   [3.1 Figures S4-5](#31-figures-s4-5)
    -   [3.2 Figure S6](#32-figure-s6)
    -   [3.3 Figure S7](#33-figure-s7)
-   [4 Supplementary tables](#4-supplementary-tables)
    -   [4.1 Table S1](#41-table-s1)
    -   [4.2 Table S2](#42-table-s2)
    -   [4.3 Table S3](#43-table-s3)
...
```
    ...
    ## here() starts at /media/ptschanz/Data/PhD/Manuscripts/Field Survey/GitHub/Tschanz_et_al_2022_JAppEcol
...
```
    ...
    ##   `/media/ptschanz/Data/PhD/Manuscripts/Field Survey/GitHub/Tschanz_et_al_2022_JAppEcol/data/geodata.gpkg' 
    ##   using driver `GPKG'
...
management treatment. Thus, we have
![N=2](https://latex.codecogs.com/png.image?%5Cdpi%7B110%7D&space;%5Cbg_white&space;N%3D2 "N=2")
assemblages (NT and CT).
...
```
    ...
    ## # A tibble: 16 × 8
    ##    variable           summary       t_stat t_df  t_pval mwu_stat mwu_df mwu_pval
    ##    <chr>              <chr>         <chr>  <chr> <chr>  <chr>    <chr>  <chr>   
    ##  1 area_ha            NT: 3.58 ± 0… -0.24  22.97 0.809  -0.24    22.97  0.807   
    ##  2 area_ha            CT: 3.43 ± 0… -0.24  22.97 0.809  -0.24    22.97  0.807   
    ##  3 alt_plot           NT: 452.05 ±… 0.64   22.80 0.526  0.64     22.80  0.265   
    ##  4 alt_plot           CT: 477.65 ±… 0.64   22.80 0.526  0.64     22.80  0.265   
    ##  5 slope_plot         NT: 1.96 ± 0… -1.02  20.65 0.318  -1.02    20.65  0.497   
    ##  6 slope_plot         CT: 1.59 ± 0… -1.02  20.65 0.318  -1.02    20.65  0.497   
    ##  7 lsc_BPA_500m       NT: 6.19 ± 1… 0.53   23.00 0.601  0.53     23.00  0.724   
    ##  8 lsc_BPA_500m       CT: 6.97 ± 1… 0.53   23.00 0.601  0.53     23.00  0.724   
    ##  9 lsc_Forest_500m    NT: 10.11 ± … 0.51   19.40 0.616  0.51     19.40  0.724   
    ## 10 lsc_Forest_500m    CT: 12.98 ± … 0.51   19.40 0.616  0.51     19.40  0.724   
    ## 11 lsc_Grassland_500m NT: 14.38 ± … -0.07  21.88 0.946  -0.07    21.88  0.765   
    ## 12 lsc_Grassland_500m CT: 14.16 ± … -0.07  21.88 0.946  -0.07    21.88  0.765   
    ## 13 lsc_Crop_500m      NT: 59.47 ± … -0.10  22.38 0.924  -0.10    22.38  0.935   
    ## 14 lsc_Crop_500m      CT: 58.85 ± … -0.10  22.38 0.924  -0.10    22.38  0.935   
    ## 15 lsc_Urban_500m     NT: 11.03 ± … 0.24   22.65 0.815  0.24     22.65  0.849   
    ## 16 lsc_Urban_500m     CT: 11.84 ± … 0.24   22.65 0.815  0.24     22.65  0.849
